#ifndef _SRENDERER_COMMON_BESSEL_HLSLI_
#define _SRENDERER_COMMON_BESSEL_HLSLI_
...
/*------------------------------------------------------------*/
{
    ...
    if ((ax = fabs(x)) < 8.0) {
        ...
        ans1 = 57568490574.0 + y * (-13362590354.0 + y * (651619640.7
         + y * (-11214424.18 + y * (77392.33017 + y * double(-184.9052456)))));
...
/*------------------------------------------------------------*/
{
    ...
    if ((ax = fabs(x)) < 8.0) {
        ...
        ans1 = x * (72362614232.0 + y * (-7895059235.0 + y * (242396853.1
         + y * (-2972611.439 + y * (15704.48260 + y * double(-30.16036606))))));
        ...
        ans1 = 1.0 + y * (0.183105e-2 + y * (-0.3516396496e-4
         + y * (0.2457520174e-5 + y * double(-0.240337019e-6))));
...
/*------------------------------------------------------------*/
{
    ...
    if (x < 8.0) {
        ...
        ans = (ans1 / ans2) + 0.636619772 * bessj0(x) * log_double(x);
    } else {
        z = 8.0 / x;
        y = z * z;
        xx = x - 0.785398164;
...
/*------------------------------------------------------------*/
{
    ...
    if (x < 8.0) {
        ...
        ans = (ans1 / ans2) + 0.636619772 * (bessj1(x) * log_double(x) - 1.0 / x);
    } else {
        z = 8.0 / x;
        y = z * z;
        xx = x - 2.356194491;
...
/*------------------------------------------------------------*/
{
    ...
    if ((ax = fabs(x)) < 3.75) {
        ...
        y = 3.75 / ax;
        ans = (exp_double(ax) / sqrt(ax)) * (0.39894228 + y * (0.1328592e-1
...
/*------------------------------------------------------------*/
{
    ...
    if (x <= 2.0) {
        y = x * x / 4.0;
        ans = (-log_double(x / 2.0) * bessi0(x)) + (-0.57721566 + y * (0.42278420
         + y * (0.23069756 + y * (0.3488590e-1 + y * (0.262698e-2
         + y * (0.10750e-3 + y * 0.74e-5))))));
    } else {
        y = 2.0 / x;
        ans = (exp_double(-x) / sqrt(x)) * (1.25331414 + y * (-0.7832358e-1
...
/*------------------------------------------------------------*/
{
    ...
    if (x <= 2.0) {
        y = x * x / 4.0;
        ans = (log_double(x / 2.0) * bessi1(x)) + (1.0 / x) * (1.0 + y * (0.15443144
         + y * (-0.67278579 + y * (-0.18156897 + y * (-0.1919402e-1
         + y * (-0.110404e-2 + y * double(-0.4686e-4)))))));
    } else {
        y = 2.0 / x;
        ans = (exp_double(-x) / sqrt(x)) * (1.25331414 + y * (0.23498619
         + y * (-0.3655620e-1 + y * (0.1504268e-1 + y * (-0.780353e-2
         + y * (0.325614e-2 + y * double(-0.68245e-3)))))));
    }
    return ans;
}
...
#endif // _SRENDERER_COMMON_BESSEL_HLSLI_