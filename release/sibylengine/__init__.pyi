...
class rhi:
    ...
    class Semaphore:
        def wait(self, timeline_value: int = 0) -> None: ...
        ...
...
class gfx:
    ...
    class SceneHandle:
        ...
        def set_viewport_size(self, size: ivec2) -> None: ...
        def invalid_gpu_resources(self) -> None: ...

    class SceneBatch:
        def emplace_scene(self, scene: gfx.SceneHandle) -> None: ...
        def update_gpu_scene_batch(self) -> None: ...
        def gpu_scene(self) -> gfx.GPUScene: ...
        ...
    ...
    class GFXContext:
        ...
        @staticmethod
        def create_scene_batch() -> gfx.SceneBatch: ...

        @staticmethod
        def number_of_cached_buffers() -> int: ...
...
class rdg:
    ...
    class RenderPass(rdg.PipelinePass):
        ...
        def update_binding_scene_batch(
            context: rdg.RenderContext,
            sceneBatch:gfx.SceneBatch
        ) -> None: ...
    ...
    class ComputePass(rdg.PipelinePass):
        ...
        def __init__(self, shader_path: str, macros: list[tuple[str, str]]) -> None: ...
        def init(self, shader:object) -> None: ...
        def init(self, shader_file:str, macros:list[tuple[str, str]]) -> None: ...
        def update_bindings(
            context: rdg.RenderContext,
            bindings: list[tuple[str, rhi.BindingResource]]
        ) -> None: ...
    ...
    class RenderData:
        ...
        def get_scene_batch(self) -> gfx.SceneBatch: ...
        def set_scene(self, scene:gfx.SceneHandle) -> None: ...
        def set_scene_batch(self, scene:gfx.SceneBatch) -> None: ...
...
import numpy as np
def generate_pmj_samples_dim3(x0:int, x1:int, y0:int, y1:int, nSamples:int, frame:int) -> np.ndarray: ...
def generate_pmj_samples_dim2x2(x0:int, x1:int, y0:int, y1:int, nSamples:int, frame:int) -> np.ndarray: ...
def generate_pmjbn_samples_dim2x2(x0:int, x1:int, y0:int, y1:int, nSamples:int, frame:int) -> np.ndarray: ...
